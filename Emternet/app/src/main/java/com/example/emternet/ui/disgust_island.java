...
public class disgust_island extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_disgust_island);
            ...
            public void onClick(View view) {
                ...
                for (int i = 0;i< slist.length;i++){
                    if(xx==i){
                        ...
                        Intent myIntent = new Intent(disgust_island.this, Chating.class);
